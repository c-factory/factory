...
static string_t * create_cmd_line_link_for_gcc(string_t *target_folder, vector_t *object_file_list, string_t *exe_file)
{
    ...
    string_t *cmd = create_formatted_string("gcc %S -o %S%c%S",
